...
def get_anagram_array_from_api
  ...
  if api_return_array.any? == true
    ...
    puts "\nThere are" + " #{api_return_array.length}".colorize(color: :magenta, mode: :bold) + " anagrams to find!! Try to find as many as you can...You have 25 seconds!!...".colorize(color: :magenta, mode: :bold)
    sleep(1)
